#ifndef DRIVERS_LORA_RF95_H_
#define DRIVERS_LORA_RF95_H_

#include <stdint.h>

// According to RFM96W-V2.0.pdf write needs wnr bit [8] 1
#define RF95_WRITE_MASK 0x80
...
static const ModemConfig MODEM_CONFIG_TABLE[] = {
        ...
        { 0x72, 0xc4, 0x0c }, // Bw125Cr45Sf4094, AGC enabled, mobile node
...
typedef enum
{
    ...
    Bw125Cr45Sf4094, ///< Bw = 125 kHz, Cr = 4/5, Sf = 4096chips/symbol, CRC on. Slow+long range, mobile node, AGC
} ModemConfigChoice;
